...
public class TicketController {
  ...
  @PatchMapping("/{id}/status") public LegalTicket status(@PathVariable("id") Long id, @RequestParam("status") TicketStatus status) { return service.updateStatus(id, status); }
  @PostMapping("/{id}/replies") public Map<String, Object> reply(@PathVariable("id") Long id, @RequestBody Map<String, Object> body) { return service.reply(id, String.valueOf(body.get("content")), (List<String>) body.getOrDefault("attachments", List.of())); }
}
